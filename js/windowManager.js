...
export function createWindow(title, customCode) {
  ...
  switch (originalTitle) {
    ...
    case 'Mario':
      ...
      content = customCode ? customCode : `
        <div style="width: 100%; height: 100%;">
          <iframe src="https://html-classic.itch.zone/html/13102180/Web/index.html" style="width: 100%; height: 100%; border: none; display: block; overflow: auto;"></iframe>
        </div>
      `;
    ...
    case 'Information':
      ...
      content = `
        ...
        <div>
          ...
          <p><strong>Credits:</strong><br>
            ...
            The 3D Pinball game is from <a href="https://ksylvestre.itch.io/space-cadet-pinball" target="_blank" rel="noopener noreferrer">ksylvestre.itch.io</a>.
          </p>
      ...
      break;
    case 'Pinball':
      bodyHTML = `<div class="window-body pinball-window" style="overflow: hidden;">`;
      content = `
        <iframe src="https://html-classic.itch.zone/html/13464004/index.html" scrolling="no" style="width: calc(100% + 5px); height: calc(100% + 8px); border: none; display: block; transform: translate(-5px, -8px);"></iframe>
      `;
      win.style.width = '604px';
      win.style.height = '442px';
      break;
    case 'Solitaire':
      bodyHTML = `<div class="window-body pvz-window" style="overflow: hidden;">`;
